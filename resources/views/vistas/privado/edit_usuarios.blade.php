                ...
                <form action="{{route('usuarios.update', $infoUser->id)}}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{old('name', $infoUser->name)}}" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Nombre de Usuario:</label>
                            <input type="text" id="username" name="username" value="{{old('username', $infoUser->username)}}" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="email">Correo Electrónico:</label>
                            <input type="email" id="email" name="email" value="{{old('email', $infoUser->email)}}" required>
                        </div>
                        <div class="form-group">
                            <label for="cedula">Número de Cédula:</label>
                            <input type="tel" id="cedula" name="cedula" value="{{old('cedula', $infoUser->cedula)}}" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="phone">Teléfono:</label>
                            <input type="tel" id="phone" name="phone" value="{{old('phone', $infoUser->phone)}}" required>
                        </div>
                        <div class="form-group">
                            <label for="nacimiento">Fecha de Nacimiento:</label>
                            <input type="date" id="nacimiento" name="nacimiento" value="{{old('nacimiento', $infoUser->nacimiento)}}" required>
                        </div>
                    </div>
                            ...
                            <hr>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="accountNumberCorriente" name="accountNumberCorriente" value="{{old('accountNumberCorriente', $cuenta->accountNumber)}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="availableBalanceCorriente">Saldo:</label>
                                        <input type="numeric" id="availableBalanceCorriente" name="availableBalanceCorriente" value="{{old('availableBalanceCorriente', $cuenta->availableBalance)}}" required>
                                    </div>
                                </div>
                            @else
                                <hr>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="accountNumberAhorro" name="accountNumberAhorro" value="{{old('accountNumberAhorro', $cuenta->accountNumber)}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="availableBalanceAhorro">Saldo:</label>
                                        <input type="numeric" id="availableBalanceAhorro" name="availableBalanceAhorro" value="{{old('availableBalanceAhorro', $cuenta->availableBalance)}}" required>
                                    </div>
                                </div>
                            @endif
                        @endforeach 
