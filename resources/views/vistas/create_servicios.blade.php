                ...
                formularioServicio.innerHTML = `
                    <form method="POST" action="{{route('servicios.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select-yo" id="select-yo" name="cuentaTypeLogin2">
                            ...
                            @error('cuentaTypeLogin2')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="operadora_movil">Elija una operadora movil:</label>
                            <select class="select-yo" id="operadora_movil" name="operadora_movil">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select-yo" id="montoInput" name="monto">
                ...
                formularioServicio.innerHTML = `
                    <form method="POST" action="{{route('servicios.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select-yo" id="operadora_internetInput" name="operadora_internet">
                                <option value="">Seleccione una operadora</option>
                            ...
                            @error('operadora_internet')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="montoInput">Monto a Pagar (Bs):</label>
                            <input type="number" id="montoInput" name="monto" step="0.01" min="0.01" value="{{old('monto')}}" required>
                            @error('monto')
                                {{$message}}
                            @enderror
                        </div>
                ...
                formularioServicio.innerHTML = `
                    <form method="POST" action="{{route('servicios.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select-yo" id="servicio_publicoInput" name="servicio_publico">
