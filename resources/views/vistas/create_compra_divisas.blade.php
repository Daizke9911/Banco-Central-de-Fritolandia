        ...
        <main class="main-content">
            ...
            <div class="content-area">
                    <div class="transferencia-container">
                        @if ($i > 0) 
                            <form id="transferencia-form" method="POST" action="{{route('monedas.store')}}"
                            data-precio-dolar="{{ $monedas->precio ?? 0 }}">
                                ...
                                <div class="form-group">
                                    <label for="precio-dolar">Precio de Compra:</label>
                                ...
                                <div class="form-group">
                                    <label for="moneyInput">Cantidad de Dolares ($):</label>
                                ...
                                <div class="form-group">
                                    <label for="resultado-multiplicado">Precio en Fritos:</label>
